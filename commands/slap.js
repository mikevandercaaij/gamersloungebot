...
module.exports = {
    name: 'slap',
    description: 'Roleplay slap another member',
    execute(client, message, args, Discord) {
        ...
        async function getIMG(){
            ...
            .setColor('#BF63DC')
            .setAuthor(`${message.author.username} slaps ${usernameMention}`, `https://cdn.discordapp.com/avatars/${authorVar.id}/${authorVar.avatar}.png`)
